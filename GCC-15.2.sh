...
git clone --progress -b amiga-gcc-15.2 /home/willem/ApolloCrossDev.Sources/amiga-gcc 2>>$LOGFILES/part3_err.log
...
cd $ARCHIVES
cp -r -f SDL/* $PREFIX >>$LOGFILES/part6.log 2>>$LOGFILES/part6_err.log
