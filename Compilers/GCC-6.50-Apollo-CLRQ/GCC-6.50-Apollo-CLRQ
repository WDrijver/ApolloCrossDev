# ApolloCrossDev GCC-6.50 - Install Script v0.8 - Apollo CLRQ
EDITION=GCC-6.50
VERSION=0.8
CPU=-j16
...
git clone --progress -b WD-Apollo-CLRQ https://github.com/WDrijver/amiga-gcc 2>>$LOGFILES/part3_err.log
